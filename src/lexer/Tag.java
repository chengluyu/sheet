...
public enum Tag {
	...
	LPAREN("(", TokenType.OPERATOR, LBP_REFINEMENT),
	RPAREN(")", TokenType.OPERATOR),
	LBRACK("[", TokenType.OPERATOR, LBP_REFINEMENT),
	...
	PERIOD(".", TokenType.OPERATOR, LBP_REFINEMENT),
	ELLIPSIS("...", TokenType.OPERATOR),
	CONDITIONAL("?", TokenType.OPERATOR, LBP_CONDITIONAL),
	INC("++", TokenType.OPERATOR, LBP_UNARY),
	DEC("--", TokenType.OPERATOR, LBP_UNARY),

	ASSIGN("=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_BIT_OR("|=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_BIT_XOR("^=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_BIT_AND("&=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_SHL("<<=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_SHR(">>=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_SAR(">>>=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_ADD("+=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_SUB("-=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_MUL("*=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_DIV("/=", TokenType.OPERATOR, LBP_ASSIGNMENT),
	ASSIGN_MOD("%=", TokenType.OPERATOR, LBP_ASSIGNMENT),

	COMMA(",", TokenType.OPERATOR, LBP_COMMA),
	OR("||", TokenType.OPERATOR, LBP_OR),
	AND("&&", TokenType.OPERATOR, LBP_AND),
	BIT_OR("|", TokenType.OPERATOR, LBP_BIT_OR),
	BIT_XOR("^", TokenType.OPERATOR, LBP_BIT_XOR),
	BIT_AND("&", TokenType.OPERATOR, LBP_BIT_AND),
	SHL("<<", TokenType.OPERATOR, LBP_BITWISE),
	SHR(">>", TokenType.OPERATOR, LBP_BITWISE),
	SAR(">>>", TokenType.OPERATOR, LBP_BITWISE),
	ADD("+", TokenType.OPERATOR, LBP_FACTOR),
	SUB("-", TokenType.OPERATOR, LBP_FACTOR),
	MUL("*", TokenType.OPERATOR, LBP_TERM),
	DIV("/", TokenType.OPERATOR, LBP_TERM),
	MOD("%", TokenType.OPERATOR, LBP_TERM),
	
	EQ("==", TokenType.OPERATOR, LBP_EQUALITY),
	NE("!=", TokenType.OPERATOR, LBP_EQUALITY),
	LT("<", TokenType.OPERATOR, LBP_INEQUALITY),
	GT(">", TokenType.OPERATOR, LBP_INEQUALITY),
	LTE("<=", TokenType.OPERATOR, LBP_INEQUALITY),
	GTE(">=", TokenType.OPERATOR, LBP_INEQUALITY),
	
	NOT("!", TokenType.OPERATOR, LBP_UNARY),
	BIT_NOT("~", TokenType.OPERATOR, LBP_UNARY),
